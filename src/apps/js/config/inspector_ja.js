...
(function() {
    ...
    var options = {
        ...
        fontWeight: [
            { value: '300', content: '<span style="font-weight: 300">右</span>' },
            { value: 'Normal', content: '<span style="font-weight: Normal">標準</span>' },
            { value: 'Bold', content: '<span style="font-weight: Bolder">太字</span>' }
        ],
        ...
        strokeStyle: [
            { value: '0', content: 'ソリッド' },
            { value: '2,5', content: '点がある' },
            { value: '10,5', content: '打ちつける' }
        ],

        side: [
            { value: 'top', content: 'トップサイド ' },
            { value: 'right', content: '正しい Side' },
            { value: 'bottom', content: 'Bottom Side' },
            { value: 'left', content: '左' }
        ],

        portLabelPositionRectangle: [
            { value: { name: 'top', args: { y: -12 }}, content: 'Above' },
            { value: { name: 'right', args: { y: 0 }}, content: '右側に' },
            { value: { name: 'bottom', args: { y: 12 }}, content: '下記' },
            { value: { name: 'left', args: { y: 0 }}, content: '左側に ' }
        ],

        portLabelPositionEllipse: [
            { value: 'radial' , content: 'ホリゾンタル' },
        ...
        arrowheadSize: [
            { value: 'scale(0.001)', content: 'なし' },
            { value: 'scale(1)', content: '小さい' },
            { value: 'scale(2)', content: 'Medium' },
            { value: 'scale(4)', content: '大きい' }
        ],
        ...
        labelPosition: [
            { value: 30, content: 'ソースに近づく' },
            { value: 0.5, content: '真ん中' },
            { value: -30, content: 'ターゲットに近づく' },
        ],

        portMarkup: [
            { value: '<rect class="port-body" width="20" height="20" x="-10" y="-10"/>', content: '長方形' },
            { value: '<circle class="port-body" r="10"/>', content: 'サークル' },
            { value: '<path class="port-body" d="M -10 -10 10 -10 0 10 z"/>', content: '三角形 ' }
        ]
    };
